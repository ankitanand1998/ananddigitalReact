  ...
  return (
    <div className="pt-16">
     <Helmet>
            ...
            <link rel="canonical" href="https://www.ananddigitalpr.com/services/digital-marketing/public-relations" />
            ...
            />
            <meta property="og:url" content="https://www.ananddigitalpr.com/services/digital-marketing/public-relations" />
...
{/* Hero Section */}
      <section className="relative h-[60vh]">
        ...
        >
          <div>
            <h1 className="text-4xl md:text-4xl font-bold mb-6">Best Digital Marketing & Digital PR Services in India – Trusted by Brands</h1>
      ...
      <section ref={ref} className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
         <h2 className="text-4xl md:text-4xl font-bold mb-5">We provide everything you need to grow your business online – all in one place</h2>
